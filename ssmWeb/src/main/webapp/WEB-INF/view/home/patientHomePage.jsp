...
<div class="layui-fluid">
    ...
    <div class="layui-row" style="margin-top: 6px;height: 10%">
        <ul class="layui-nav">
            ...
            <li class="layui-nav-item"><a href="javascript:loadPage('/view/viewManagement/departmentIntroduction.jsp')">科室介绍</a></li>
    ...
    <div class="layui-row" style="margin-top: 30px;height: 30%">
